...
class Kasus extends CI_Model
{
    ...
    function get_kasus_by_user_id_kasus($user_id,$slug=0){
        $this->db->select(
            $this->table.".id,".
            $this->table.".judul,".
            $this->table.".is_kusus,".
    ...
    function get_kasus_by_status($status=0,$user_id=0,$search=0,$order_by="desc",$domisili=0){
        $this->db->select(
            $this->table.".id,".
            $this->table.".judul,".
            $this->table.".is_kusus,".
        ...
        if($domisili) {
            $this->db->like($this->table.".lokasi_kejadian",$domisili,"after");
        }
        $query=$this->db->get($this->table);
        if($query){
            return $query->result();
    ...
    function get_kasus_by_only_id($slug=0){
        $this->db->select(
            $this->table.".id,".
            $this->table.".judul,".
            $this->table.".is_kusus,".
