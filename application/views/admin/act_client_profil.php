...
?>
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Client Profile</h4>
    </div><!-- d-flex -->
        ...
        <div class="card shadow-base bd-0 rounded-0 widget-4">
            ...
            <div class="card-body">
                <div class="card-profile-img">
                    <?php
                    $photo_profile = !empty($values->foto)?base_url().'probono_asset/probono/asset/'.$values->foto:base_url().'assets_123/img/default-avatar.png';
                    ?>
                ...
                <div class="bd rounded table-responsive">
                    <table id="tableProfile" class="table table-bordered mg-b-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo !empty($values->nama_samaran)?$values->nama_samaran:"-"; ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo !empty($values->pekerjaan)?$values->pekerjaan:""; ?>
                            </td>
                        </tr>
                        <tr>
                            <td width="30%"><b>Penghasilan</b></td>
                            <td>
                                <?php echo !empty($values->penghasilan)?$values->penghasilan:""; ?>
                            </td>
                        </tr>
                        <tr>
