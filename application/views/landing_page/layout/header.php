        ...
        var submit = function (response){
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    //alert(data.is_error +'aa'+data.ada_kasus);
                    if($('#user_set').is(":checked") === true && data.ada_kasus >= 1){
                        // alert(data.is_error +'bb'+data.ada_kasus);
                        window.location = "<?php echo base_url().'client/kasus_aktif'; ?>";
                    }else if($('#user_set').is(":checked") === true){
